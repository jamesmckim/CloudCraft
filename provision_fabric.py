...
ansible_ssh_common_args='-o ProxyCommand="ssh -W %h:%p -i ~/.ssh/fabric-bastion-key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null {bastion_user}@{bastion_host}"'
"""
